            ...
            <div className="animate-on-scroll opacity-0" style={{ transitionDelay: '200ms' }}>
              <div className="h-full w-full overflow-hidden rounded-xl relative group">
                <div className="aspect-square bg-white/5 backdrop-blur-sm rounded-xl relative overflow-hidden border border-white/10 hover:border-portfolio-accent/50 transition-all duration-500">
                  ...
                  {/* Decorative elements */}
                  <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-portfolio-accent/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                  <div className="absolute -bottom-2 -right-2 w-32 h-32 bg-portfolio-accent/20 rounded-full blur-2xl"></div>
                  
                  {/* Corner accent */}
                  <div className="absolute bottom-0 right-0 w-12 h-12 bg-portfolio-accent/20 backdrop-blur-md border-t border-l border-white/10"></div>
                </div>
              </div>
            </div>
